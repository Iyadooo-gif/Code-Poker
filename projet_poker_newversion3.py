...
class Partie:
    ...
    def ia_jouer(self):
        ...
        if force_main > 50:  # L'IA mise si elle a une "main correcte"
            mise = min(10, self.joueur_ia.tapis)
...
class PokerApp:
    ...
    def nouvelle_partie(self):
        ...
        self.canvas.create_rectangle(50, 450, 750, 550, fill="brown")  # Table de jeu

        # Affichage du joueur et de l'IA
        self.afficher_cartes(self.joueur_humain, 150, 400)
        self.afficher_cartes(self.joueur_ia, 150, 100, face_cachee=True)
